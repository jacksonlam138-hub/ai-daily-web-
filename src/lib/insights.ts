...
每条可以没有任何建议。只在存在清楚、直接的角色相关性时给该角色 1–2 项，整段建议 40–100 字，最多 240 字。每项必须独立换行，格式为“1. 短标题：一句解释。”，短标题 2–6 字，每项只表达一个判断或行动。不要写开场总论、结尾总结或用分号把编号挤成一段；角色标题由页面显示，不写入内容。禁止为覆盖角色而凑数、套话、虚构功能与效果、夸大或暗示已核验。不要复述摘要，不要写通用的“持续关注”。
